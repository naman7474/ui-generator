...
function FAQ() {
  ...
  return /* @__PURE__ */ React.createElement("section", { className: "py-16 px-5 max-w-3xl mx-auto" }, /* @__PURE__ */ React.createElement("h2", { className: "text-3xl font-serif text-center mb-12 uppercase" }, "NEED MORE EVIDENCE?"), /* @__PURE__ */ React.createElement("div", { className: "space-y-2" }, faqs.map((faq, idx) => /* @__PURE__ */ React.createElement("div", { key: idx, className: "border-b border-gray-100 pb-2" }, /* @__PURE__ */ React.createElement(
    "button",
    {
    ...
    /* @__PURE__ */ React.createElement("span", { className: "font-medium text-lg group-hover:pl-2 transition-all" }, faq.q),
    openIndex === idx ? /* @__PURE__ */ React.createElement(Minus, { size: 20, className: "text-brand-orange" }) : /* @__PURE__ */ React.createElement(Plus, { size: 20, className: "text-gray-400" })
  ), openIndex === idx && /* @__PURE__ */ React.createElement("div", { className: "pb-4 text-gray-600 leading-relaxed text-sm" }, faq.a)))));
}
export {
  FAQ as default
};
