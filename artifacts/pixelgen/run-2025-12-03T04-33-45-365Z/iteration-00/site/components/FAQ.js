...
function FAQ() {
  ...
  return /* @__PURE__ */ React.createElement("section", { className: "py-16 px-4 max-w-3xl mx-auto" }, /* @__PURE__ */ React.createElement("h2", { className: "text-2xl md:text-3xl font-light text-center mb-12 uppercase tracking-widest" }, "Need More Evidence?"), /* @__PURE__ */ React.createElement("div", { className: "space-y-4" }, faqs.map((faq, index) => /* @__PURE__ */ React.createElement("div", { key: index, className: "border-b border-gray-200 pb-4" }, /* @__PURE__ */ React.createElement(
    "button",
    {
