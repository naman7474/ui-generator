...
function ProductList() {
  ...
  return /* @__PURE__ */ React.createElement("section", { className: "py-10 md:py-16 container mx-auto px-4" }, /* @__PURE__ */ React.createElement("div", { className: "text-center mb-10" }, /* @__PURE__ */ React.createElement("h2", { className: "text-3xl md:text-4xl font-heading font-medium tracking-wide py-10" }, "NEW FLAVOR EVERYDAY"), /* @__PURE__ */ React.createElement("div", { className: "flex justify-center items-center gap-6 mb-12" }, /* @__PURE__ */ React.createElement(
    "div",
    {
      className: `cursor-pointer flex items-center pl-6 pr-1 py-1 rounded-full transition-all ${activeTab === "TIKKAS" ? "bg-brand-brown text-white shadow-lg scale-105" : "bg-white border border-brand-brown text-brand-brown"}`,
      onClick: () => setActiveTab("TIKKAS")
    },
    /* @__PURE__ */ React.createElement("span", { className: "font-bold text-sm tracking-wider mr-3" }, "TIKKAS"),
    /* @__PURE__ */ React.createElement("div", { className: "w-10 h-10 rounded-full bg-white overflow-hidden border-2 border-white" }, /* @__PURE__ */ React.createElement("img", { src: "assets/images/8bee64915c.png", className: "w-full h-full object-cover", alt: "Tikkas" }))
  ), /* @__PURE__ */ React.createElement(
    "div",
    {
      className: `relative cursor-pointer flex items-center pl-6 pr-1 py-1 rounded-full transition-all ${activeTab === "GRAVIES" ? "bg-brand-brown text-white shadow-lg scale-105" : "bg-white border border-brand-brown text-brand-brown"}`,
      onClick: () => setActiveTab("GRAVIES")
    },
    /* @__PURE__ */ React.createElement("div", { className: "absolute -top-3 left-1/2 -translate-x-1/2 bg-[#22c55e] text-white text-[8px] font-bold px-2 py-0.5 rounded-sm uppercase tracking-tighter" }, "New Launch"),
    /* @__PURE__ */ React.createElement("span", { className: "font-bold text-sm tracking-wider mr-3" }, "GRAVIES"),
    /* @__PURE__ */ React.createElement("div", { className: "w-10 h-10 rounded-full bg-white overflow-hidden border-2 border-white" }, /* @__PURE__ */ React.createElement("img", { src: "assets/images/a4f1e17947.png", className: "w-full h-full object-cover", alt: "Gravies" }))
