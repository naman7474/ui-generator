...
const FAQS = [
  ...
  { q: "Why not buy pre-marinated chicken?", a: "Freshly marinated is always better. You control the quality of the meat/veg, we just provide the killer taste." },
  { q: "What about other flavor masalas?", a: "We are constantly innovating! Check our 'New Launch' section for the latest drops." }
];
function FAQ() {
  ...
  return /* @__PURE__ */ React.createElement("section", { className: "py-16 bg-white" }, /* @__PURE__ */ React.createElement("div", { className: "container mx-auto px-4 max-w-3xl" }, /* @__PURE__ */ React.createElement("h2", { className: "text-3xl font-display font-medium uppercase text-center mb-12" }, "Need More Evidence?"), /* @__PURE__ */ React.createElement("div", { className: "divide-y divide-gray-100" }, FAQS.map((faq, idx) => /* @__PURE__ */ React.createElement("div", { key: idx, className: "py-4" }, /* @__PURE__ */ React.createElement(
    "button",
    {
      onClick: () => toggle(idx),
  ...
  ), openIndex === idx && /* @__PURE__ */ React.createElement("div", { className: "mt-3 text-gray-600 leading-relaxed animate-fadeIn" }, faq.a))))));
}
export {
  FAQ as default
};
