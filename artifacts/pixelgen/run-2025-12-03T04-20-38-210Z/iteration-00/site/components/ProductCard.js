...
function ProductCard({ product }) {
  ...
  )))), /* @__PURE__ */ React.createElement("div", { className: "w-full md:w-1/2 flex flex-col justify-center py-4" }, /* @__PURE__ */ React.createElement("h3", { className: "text-2xl font-bold uppercase mb-2" }, product.title), /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-3 mb-4" }, /* @__PURE__ */ React.createElement("span", { className: "text-xl font-bold" }, "\u20B9", product.price), /* @__PURE__ */ React.createElement("span", { className: "text-gray-400 line-through text-sm" }, "\u20B9", product.originalPrice)), /* @__PURE__ */ React.createElement("p", { className: "text-gray-600 mb-8 leading-relaxed" }, product.description), /* @__PURE__ */ React.createElement("button", { className: "bg-brand-orange text-white px-8 py-3 w-fit font-bold uppercase tracking-wider flex items-center gap-2 hover:bg-orange-700 transition-colors" }, /* @__PURE__ */ React.createElement(Plus, { size: 18 }), " Add")));
}
export {
