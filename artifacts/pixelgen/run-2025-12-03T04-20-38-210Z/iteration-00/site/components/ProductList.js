...
const PRODUCTS = [
  ...
  },
  {
    ...
    thumbnails: [
      ...
      "https://images.unsplash.com/photo-1610057099443-fde8c4d50f91?auto=format&fit=crop&w=100&q=80"
    ]
  },
  {
    id: 3,
...
function ProductList() {
  ...
  return /* @__PURE__ */ React.createElement("section", { className: "py-16 container mx-auto px-4" }, /* @__PURE__ */ React.createElement("div", { className: "text-center mb-12" }, /* @__PURE__ */ React.createElement("h2", { className: "text-3xl md:text-4xl font-display font-medium tracking-wide mb-8 uppercase" }, "New Flavor Everyday"), /* @__PURE__ */ React.createElement("div", { className: "flex justify-center items-center gap-4" }, /* @__PURE__ */ React.createElement(
    "button",
    {
    ...
    "button",
    {
      ...
      className: `px-6 py-2 rounded-full font-bold text-sm flex items-center gap-2 transition-all ${activeTab === "GRAVIES" ? "bg-brand-orange text-white" : "bg-gray-200 text-gray-600"}`
    },
