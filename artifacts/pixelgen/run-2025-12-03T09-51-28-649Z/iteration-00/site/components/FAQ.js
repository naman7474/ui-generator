...
function FAQ() {
  ...
  return /* @__PURE__ */ React.createElement("section", { className: "py-16 bg-white" }, /* @__PURE__ */ React.createElement("div", { className: "container mx-auto px-4 max-w-3xl" }, /* @__PURE__ */ React.createElement("h2", { className: "text-3xl md:text-4xl font-heading font-medium uppercase text-center mb-12" }, "Need More Evidence?"), /* @__PURE__ */ React.createElement("div", { className: "divide-y divide-gray-100" }, faqs.map((faq, idx) => /* @__PURE__ */ React.createElement("div", { key: idx, className: "py-4" }, /* @__PURE__ */ React.createElement(
    "button",
    {
    ...
    /* @__PURE__ */ React.createElement("span", { className: "text-xl font-light text-gray-400" }, openIndex === idx ? "\u2212" : "+")
  ), openIndex === idx && /* @__PURE__ */ React.createElement("div", { className: "mt-3 text-sm text-gray-600 leading-relaxed animate-fadeIn" }, faq.a))))));
}
export {
  FAQ as default
};
