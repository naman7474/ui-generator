...
function ComparisonSection() {
  ...
  return /* @__PURE__ */ React.createElement("section", { className: "py-16 bg-white" }, /* @__PURE__ */ React.createElement("div", { className: "text-center mb-8" }, /* @__PURE__ */ React.createElement("p", { className: "text-[#C8553D] text-xs font-bold uppercase tracking-widest mb-2" }, "A KILRR Idea That'll Change Your Life"), /* @__PURE__ */ React.createElement("h2", { className: "text-3xl md:text-4xl font-light uppercase" }, "Slay The Mess, Savor The Taste")), /* @__PURE__ */ React.createElement(
    "div",
    {
    ...
    ), /* @__PURE__ */ React.createElement("div", { className: "absolute bottom-8 right-8 bg-white/80 px-4 py-2 rounded text-sm font-bold uppercase" }, "With KILRR")),
    /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("div", { className: "absolute bottom-8 left-8 bg-white/80 px-4 py-2 rounded text-sm font-bold uppercase" }, "Before KILRR")
    ),
    /* @__PURE__ */ React.createElement(
      "div",
      {
