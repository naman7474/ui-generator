...
function ProductCard({ product }) {
  ...
  )))), /* @__PURE__ */ React.createElement("div", { className: "w-full flex flex-col justify-start pt-0 md:pt-4" }, /* @__PURE__ */ React.createElement("div", { className: "flex flex-row md:flex-col justify-between items-center md:items-start mb-4 md:mb-0" }, /* @__PURE__ */ React.createElement("div", { className: "flex flex-col md:block" }, /* @__PURE__ */ React.createElement("h3", { className: "text-lg md:text-2xl font-bold uppercase tracking-wide mb-1 md:mb-2" }, product.name), /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-3 mb-0 md:mb-4" }, /* @__PURE__ */ React.createElement("span", { className: "text-xl font-bold" }, "\u20B9", product.price), /* @__PURE__ */ React.createElement("span", { className: "text-gray-400 line-through text-sm" }, "\u20B9", product.originalPrice))), /* @__PURE__ */ React.createElement("div", { className: "md:hidden" }, /* @__PURE__ */ React.createElement("button", { className: "bg-brand-orange text-white px-6 py-2 rounded text-sm font-bold uppercase tracking-wider hover:bg-orange-800 transition-colors" }, "+ Add"))), /* @__PURE__ */ React.createElement("p", { className: "text-gray-600 mb-6 leading-relaxed text-sm md:text-base" }, product.description), /* @__PURE__ */ React.createElement("button", { className: "hidden md:block bg-brand-orange text-white px-8 py-3 rounded font-bold uppercase tracking-wider hover:bg-orange-800 transition-colors self-start" }, "+ Add")));
}
