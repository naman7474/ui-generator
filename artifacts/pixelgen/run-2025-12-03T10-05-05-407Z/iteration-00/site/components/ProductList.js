...
function ProductList() {
  ...
  return /* @__PURE__ */ React.createElement("section", { className: "py-16 container mx-auto px-4" }, /* @__PURE__ */ React.createElement("div", { className: "text-center mb-12" }, /* @__PURE__ */ React.createElement("h2", { className: "text-3xl md:text-4xl font-heading font-medium tracking-wide mb-6" }, "NEW FLAVOR EVERYDAY"), /* @__PURE__ */ React.createElement("div", { className: "flex justify-center items-center gap-4" }, /* @__PURE__ */ React.createElement("div", { className: "relative inline-flex bg-[#FFE9BC] rounded-full p-1 cursor-pointer" }, /* @__PURE__ */ React.createElement(
    ...
    "div",
    {
      className: `px-6 py-2 rounded-full text-sm font-bold transition-all ${activeTab === "GRAVIES" ? "bg-brand-orange text-white shadow-md" : "text-[#7f7f7f]"}`,
      onClick: () => setActiveTab("GRAVIES")
    },
    "GRAVIES"
  )))), /* @__PURE__ */ React.createElement("div", { className: "space-y-20" }, products.map((product) => /* @__PURE__ */ React.createElement(ProductCard, { key: product.id, product }))), /* @__PURE__ */ React.createElement("div", { className: "mt-16 text-center" }, /* @__PURE__ */ React.createElement("button", { className: "bg-brand-orange text-white px-8 py-3 font-bold uppercase tracking-wider hover:bg-[#d44f22] transition-colors" }, "Show More (+5)")));
}
export {
