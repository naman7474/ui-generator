...
const Section1 = () => {
  return (
    <div data-section="section-1" className="w-full bg-[#e0f7fa] h-[41px] flex items-center justify-center px-4">
      <a 
        href="/pages/shine-squad-get999" 
        className="text-black text-[13px] font-medium tracking-wide text-center hover:opacity-75 transition-opacity"
      >
  ...
  return (
    ...
    >
      <div className="text-center max-w-2xl">
        ...
        <p className="text-gray-600">Section 3 - 964 elements</p>
        <p className="text-gray-500 mt-4">Sort by:...</p>
      </div>
    </main>
  );
};
